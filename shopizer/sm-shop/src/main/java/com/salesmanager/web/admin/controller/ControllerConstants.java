...
public interface ControllerConstants
{
    ...
    interface Tiles{
        ...
        interface PromotionalVoucher{
        	final String promotions="admin-promotions";
        	final String createPromotions="create-promotions";
			final String promotionsProduct = "promotions-product";
			final String promotionsCategory="promotions-categories";
        }
        interface Product{
            ...
            final String relatedManufacturerItems="admin-products-man-related";
            ...
            final String productMenuImages="admin-products-menu-images";
        }
