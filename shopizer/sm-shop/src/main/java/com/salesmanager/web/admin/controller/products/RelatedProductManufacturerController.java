...
@Controller
@RequestMapping("/admin/catalogue/related/man")
public class RelatedProductManufacturerController {
	
	private static final Logger LOGGER = LoggerFactory.getLogger(RelatedProductManufacturerController.class);
	...
	public String displayRelatedItems(@RequestParam("id") long productId, Model model, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		return ControllerConstants.Tiles.Product.relatedManufacturerItems;
	...
	public @ResponseBody String pageRelatedItems(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			List<ProductRelationship> relationships = productRelationshipService.getByType(store, product, ProductRelationshipType.MORE_FROM_MANUFACTURER, language);
	...
	public @ResponseBody String addItem(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			relationship.setCode(ProductRelationshipType.MORE_FROM_MANUFACTURER.name());
	...
	@PreAuthorize("hasRole('PRODUCTS')")
	@RequestMapping(value="/removeItem.html", method=RequestMethod.POST, produces="application/json")
	public @ResponseBody String removeItem(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			List<ProductRelationship> relationships = productRelationshipService.getByType(store, baseProduct, ProductRelationshipType.MORE_FROM_MANUFACTURER);
