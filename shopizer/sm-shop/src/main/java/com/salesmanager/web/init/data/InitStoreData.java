...
public class InitStoreData implements InitData {
	...
	public void initInitialData() throws ServiceException {
		...
		Country canada = countryService.getByCode("IN");
		Zone zone = zoneService.getByCode("IND");
		...
		ProductType generalType = productTypeService.getProductType(ProductType.GENERAL_TYPE);
		 ...
		 Category book = new Category();
		    ...
		    product.setProductShipeable(false);
		    ...
		    product2.setProductShipeable(false);
		    ...
		    product3.setProductShipeable(false);
		    ...
		    product4.setProductShipeable(false);
		    ...
		    product5.setProductShipeable(false);
		    ...
		    product6.setProductShipeable(false);
