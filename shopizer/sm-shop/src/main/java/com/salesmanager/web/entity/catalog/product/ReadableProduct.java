...
public class ReadableProduct extends ProductEntity implements Serializable {
	...
	private List<ReadableImage> menuImages;
	private ReadableManufacturer manufacturer;
	private List<ReadableProductAttribute> attributes;
	//private List<String> categories;
	@JsonIgnore
	private FinalPrice finalPriceObj = null;
	
	private List<ReadableCategory> categories = null;
	...
	public FinalPrice getFinalPriceObj() {
		return finalPriceObj;
	}
	public void setFinalPriceObj(FinalPrice finalPriceObj) {
		this.finalPriceObj = finalPriceObj;
	}
	/*public List<ReadableCategory> getCats() {
		return cats;
	}
	public void setCats(List<ReadableCategory> cats) {
		this.cats = cats;
	}*/
	...
	public List<ReadableImage> getMenuImages() {
		List<ReadableImage> imgs = new ArrayList<ReadableImage>();
		if(images != null){
			for(ReadableImage image : images){
				if(image.getImageType() !=  null && image.getImageType() == ImageType.MENU){
					imgs.add(image);
				}
			}
		}
	...
	public void setMenuImages(List<ReadableImage> menuImages) {
