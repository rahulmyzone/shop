...
public interface CustomerFacade
{
    ...
    public boolean checkIfUserExistsWithSameEmail(final SecuredShopPersistableCustomer customer,final MerchantStore store) throws Exception;
    
    public boolean checkIfUserExistsWithSamePhone(final SecuredShopPersistableCustomer customer,final MerchantStore store) throws Exception;
