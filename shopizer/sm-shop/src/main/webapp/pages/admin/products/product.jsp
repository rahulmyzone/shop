...
<div class="tabbable">
				...
				<br/><br/>
                  ...
                  <c:forEach items="${product.descriptions}" var="description" varStatus="counter">
                       ...
                       <div class="control-group">
                              <label class="required">Product Price highlight (<c:out value="${description.language.code}"/>)</label>
                              <div class="controls">
                                          <form:input cssClass="input-large" path="descriptions[${counter.index}].productPriceHighlight"/>
                                          <span class="help-inline"><form:errors path="descriptions[${counter.index}].productPriceHighlight" cssClass="error" /></span>
                              </div>
