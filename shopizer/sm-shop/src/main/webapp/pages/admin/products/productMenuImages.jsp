	...
	<div class="tab-content">
		<div class="tab-pane active" id="catalogue-section">
           <div class="sm-ui-component">
				...
				<h3>
					<s:message code="menu.catalogue-products-menu-images" text="Menu Images library" />
				</h3>
				<br/>
			...
			<!--  Add content images -->
			<c:url var="saveProductImages" value="/admin/products/images/menu/save.html" />
			...
			<div class="form-actions">
				...
				<c:set value="/admin/products/images/menu/page.html?productId=${product.id}" var="pagingUrl" scope="request" />
				<c:set value="/admin/products/images/menu/remove.html" var="removeUrl" scope="request" />
				<c:set value="/admin/products/images/menu/list.html?id=${product.id}" var="refreshUrl" scope="request" />
