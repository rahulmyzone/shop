              ...
              <div class="btn-group" style="z-index:400000;">
                    <button class="btn btn-info dropdown-toggle" data-toggle="dropdown"><s:message code="label.product.configure" text="Product definition"/> ... <span class="caret"></span></button>
                     <ul class="dropdown-menu">
				    	...
				    	<li><a href="<c:url value="/admin/products/images/menu/list.html" />?id=<c:out value="${productId}"/>"><s:message code="menu.catalogue-products-menu-images" text="Product Menu images" /></a></li>
				    	...
				    	<li><a href="<c:url value="/admin/catalogue/related/man/list.html" />?id=<c:out value="${productId}"/>"><s:message code="label.product.manufacturer.related.title" text="Manufacturer Related items" /></a></li>
