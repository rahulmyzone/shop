...
<div class="tabbable">
			...
			<div class="tab-pane active" id="catalogue-section">
				...
				<form:form method="POST" commandName="manufacturer" action="${manufacturerSave}">
					...
					<c:forEach items="${manufacturer.descriptions}" var="description" varStatus="counter">
						...
						<div class="control-group">
	                            <label class="required"><s:message code="label.manufactureredit.manufacturerAddress" text="Manufacturer Address"/> (<c:out value="${description.language.code}"/>)</label>
	                            <div class="controls">
	                     	 
	                        			 <textarea cols="30" id="descriptions${counter.index}.address" name="descriptions[${counter.index}].address">
	                        				<c:out value="${manufacturer.descriptions[counter.index].address}"/>
	                        			 </textarea>
	                            </div>	                  	
	                            <script type="text/javascript">
						//<![CDATA[

									CKEDITOR.replace('descriptions[${counter.index}].address',
									{
										skin : 'office2003',
										toolbar : 
										[
  ...
  --%>                                                 	      
                 	<div class="control-group">
                  	...
                  	<div class="control-group">
                        <label><s:message code="label.manufactureredit.manufacturerlatitude" text="Latitude"/></label>
                        <div class="controls">
                                  <form:input id="latitude" cssClass="input-large" path="manufacturer.latitude"/>
                                  <span  class="help-inline"><form:errors path="manufacturer.latitude" cssClass="error" /></span>
                        </div>
                  	</div>
                  	<div class="control-group">
                        <label><s:message code="label.manufactureredit.manufacturerlongitude" text="Longitude"/></label>
                        <div class="controls">
                                  <form:input id="longitude" cssClass="input-large" path="manufacturer.longitude"/>
                                  <span  class="help-inline"><form:errors path="manufacturer.longitude" cssClass="error" /></span>
                        </div>
                  	</div>	 
                  	<c:forEach var="merchantConfig" items="${manufacturer.wrapper.manufacturerConfigs}" varStatus="counter"> 
		                        	   <div class="control-group">
					                        ...
					                        <div class="controls">
					                        		<form:input  path="wrapper.manufacturerConfigs[${counter.index}].value" />
											        <form:hidden  path="wrapper.manufacturerConfigs[${counter.index}].key" />
											        <form:hidden  path="wrapper.manufacturerConfigs[${counter.index}].id" />
					                                <span class="help-inline"><form:errors path="wrapper.manufacturerConfigs[${counter.index}].key" cssClass="error" /></span>
					                        </div>
	                  				   </div>
	                 </c:forEach>       
