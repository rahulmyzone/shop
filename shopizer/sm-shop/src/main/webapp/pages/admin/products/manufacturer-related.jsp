...
<div class="tabbable">
				...
				<div class="alert alert-info">
				 ...
				 <c:set value="/admin/products/man/paging.html" var="pagingUrl" scope="request"/>
				 <c:set value="/admin/catalogue/related/man/paging.html?productId=${productId}" var="containerFetchUrl" scope="request"/>
				 <c:set value="/admin/catalogue/related/man/removeItem.html?baseProductId=${productId}" var="containerRemoveUrl" scope="request"/>
				 <c:set value="RELATED" var="removeEntity" scope="request"/>
				 <c:set value="/admin/catalogue/related/man/addItem.html?baseProductId=${productId}" var="containerAddUrl" scope="request"/>
				 <c:set value="/admin/catalogue/related/man/update.html" var="containerUpdateUrl" scope="request"/>
				 <c:set value="/admin/products/editProduct.html" var="editUrl" scope="request"/>
				 <c:set value="/admin/catalogue/related/man/list.html?id=${productId}" var="reloadUrl" scope="request"/>
