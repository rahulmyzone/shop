...
<%@ page session="false" %>		
                 ...
                 <div class="control-group">
                        <label class="required"><s:message code="module.payment.citrus.userid" text="Citrus API user name"/></label>
	                        <div class="controls">
	                        		<form:input cssClass="input-large highlight" path="integrationKeys['username']" />
	                        </div>
	                        <span class="help-inline">
	                        	<c:if test="${username!=null}">
	                        	<span id="identifiererrors" class="error"><s:message code="module.payment.citrus.message.identifier" text="Field in error"/></span>
	                        	</c:if>
	                        </span>
                  </div>
                  
                   <div class="control-group">
                        <label class="required"><s:message code="module.payment.citrus.apikey" text="Citrus API Key"/></label>
	                        <div class="controls">
									<form:input cssClass="input-large highlight" path="integrationKeys['api']" />
	                        </div>
	                        <span class="help-inline">
	                        	<c:if test="${api!=null}">
	                        		<span id="apikeyerrors" class="error"><s:message code="module.payment.citrus.message.api" text="Field in error"/></span>
	                        	</c:if>
	                        </span>
                  </div>

                   <div class="control-group">
                        <label class="required"><s:message code="module.payment.citrus.signature" text="Paypal API signature"/></label>
	                        <div class="controls">
									<form:input cssClass="input-large highlight" path="integrationKeys['signature']" />
	                        </div>
	                        <span class="help-inline">
	                        	<c:if test="${signature!=null}">
	                        		<span id="apisignatureerrors" class="error"><s:message code="module.payment.citrus.message.signature" text="Field in error"/></span>
	                        	</c:if>
	                        </span>
                  </div>
