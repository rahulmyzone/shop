	...
	<div class="container">
				...
				<div class="product-details">
					...
					<div class="col-sm-8">
						<div class="product-information">
							<div class="col-sm-8">
								...
								<%-- <c:choose>
									<c:when test="${product.discounted}"> --%>
										<div class="box-1">
											<span class="dealprice">${product.finalPrice}</span>
											 <c:choose>
												<c:when test="${product.discounted}">
							...
							<div class="col-sm-4">
								<div style="padding-left:5%;"><h5>More deals from ${product.manufacturer.description.name}</h5></div>
		...
		<div class="row" style="    margin-top: 25px;">
			...
			<div class="col-sm-12 recommended_items">
				<!--recommended_items-->
				<h2 class="title text-center">Deals You may like</h2>
