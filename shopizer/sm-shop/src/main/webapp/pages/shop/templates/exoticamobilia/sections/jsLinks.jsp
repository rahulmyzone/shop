...
<%@ page session="false" %>
	...
	<script src="<c:url value="/resources/templates/exoticamobilia/js/owl.carousel2.thumbs.min.js" />"></script>
	...
	<script src="<c:url value="/resources/templates/exoticamobilia/js/price-range.js" />"></script>
	<script src="<c:url value="/resources/templates/exoticamobilia/js/jquery.scrollUp.min.js" />"></script>
	<script src="<c:url value="/resources/templates/exoticamobilia/js/jquery.prettyPhoto.js" />"></script>
	<script src="<c:url value="/resources/templates/exoticamobilia/js/main.js" />"></script>
