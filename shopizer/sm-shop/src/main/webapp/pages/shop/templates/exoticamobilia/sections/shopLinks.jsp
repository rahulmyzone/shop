...
<%@ page session="false" %>
		...
		<link href="<c:url value="/resources/templates/exoticamobilia/css/owl.carousel.css" />" rel="stylesheet" type="text/css">
		<link href="<c:url value="/resources/templates/exoticamobilia/css/owl.theme.default.min.css" />" rel="stylesheet" type="text/css">
