				...
				<form:form method="post" action="${register_url}" id="registrationForm" class="form-horizontal" commandName="customer">
					...
					<fieldset>
						<div class="control-group form-group">
							<label class="required control-label" for="FirstNameRegister"><s:message code="label.generic.name" text="Name"/></label>
							<div class="controls">
							   <s:message code="NotEmpty.customer.firstName" text="Name is required" var="msgFirstName"/>
						...
						<div class="control-group form-group">
							<label class="control-label required"><s:message code="label.generic.mobile" text="Mobile Number"/></label>
							<div class="controls">
							<s:message code="NotEmpty.customer.billing.phone" text="Phone is required" var="msgPhone"/>
						...
						<div class="control-group form-group">
							<label class="required control-label" for="sex"><s:message code="label.generic.gender" text="Gender"/></label>
							<div class="controls">
						...
						<%-- <div class="control-group form-group">
							<label class="control-label required"><s:message code="label.generic.city" text="City"/></label>
							<div class="controls">
							<s:message code="NotEmpty.customer.billing.city" text="City is required" var="msgStateProvince"/>
							<form:input path="billing.city" cssClass="span8 required form-control form-control-md" id="hidden_zones" title="${msgStateProvince}"/>
							</div>
						</div> --%>		
