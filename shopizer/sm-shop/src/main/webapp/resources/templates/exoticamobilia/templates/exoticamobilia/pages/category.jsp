...
<div data-effect-delay="0" data-animation-effect="fadeInUpSmall" class="box-style-1 white-bg object-non-visible animated object-visible fadeInUpSmall">
	...
	<div class="product-image"><img class="product-img" src="{{image.imageUrl}}"><a class="overlay" href="<c:url value="/shop/product/" />{{description.friendlyUrl}}.html<sm:breadcrumbParam/>"><img class="product-img" src="<c:url value="/"/>{{image.imageUrl}}"></a></div>
