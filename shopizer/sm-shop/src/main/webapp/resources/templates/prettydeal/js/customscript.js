...
function activaTab(tab){
    $('.responsive-tabs a[href="#' + tab + '"]').tab('show');
};
function ajaxFormSubmit(form, onSuccessCallBack, onErrorCallBack){
	$(form).ajaxifyFormSubmit(onSuccessCallBack, onErrorCallBack);
	$(form).submit();
	$(form).deAjaxifyComponent("submit");
}
(function($) {
	  $.fn.ajaxifyFormSubmit = function(onSuccessCallBack, onErrorCallBack) {
...
(function($) {
	  $.fn.deAjaxifyComponent = function(event) {
		  $(this).off(event);
	  }
	})(jQuery);
(function($) {
	  $.fn.ajaxifyComponent = function(event) {
		  $(this).on(event);
	  }
	})(jQuery);
