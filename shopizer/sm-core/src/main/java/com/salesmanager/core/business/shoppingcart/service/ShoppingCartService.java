...
public interface ShoppingCartService extends SalesManagerEntityService<Long, ShoppingCart> {
	 ...
	 * @throws Exception
	 */
	public ShoppingCart mergeCartsRemoveObsolete(final ShoppingCart userShoppingCart,final ShoppingCart sessionCart,final MerchantStore store  ) throws Exception;
